...
public class InformationUserTest {
    ...
    public void setUp(){
        // Open the browser
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\Roberto\\drivers\\chromedriver.exe");
    ...
    public void testAddInformationOfUser(){
        ...
        // Identifying the field with the name "login" that is inside the id form "signinbox"
        WebElement formSignInBox = browser.findElement(By.id("signinbox"));

        // Enter the text "julio0001" in the field with the name "login" inside the id form "signinbox"
